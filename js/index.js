$(document).ready(function () {
    ...
    function setTitle(cardTitle) {
        ...
        if (cardTitle == 'Vorbereitung') {
            text = 'Zu Beginn eines PV-Projektes sollte überlegt werden, auf welchen Dächern (Schrägdach, Flachdach, Garage, Gartenhaus) Solarmodule installiert werden können, ob genügend Platz vorhanden ist und ob die Ausrichtung der Dächer für die Solarstromerzeugung geeignet ist: Den höchsten Jahresertrag erzielt man auf Dächern mit Südausrichtung und einer Neigung von ca. 30 Grad. Aber auch eine Ost-West-Ausrichtung kann durchaus sinnvoll sein, da man dann zwar einen etwas geringeren Jahresertrag erzielt, dafür aber in den Morgen- und Abendstunden mehr Energie erzeugt als mit einer nur nach Süden ausgerichteten Anlage. Insbesondere für PV-Anlagen ohne Batterie ist daher eine Ost-West-Ausrichtung attraktiv, da sich der Stromertrag über einen längeren Zeitraum pro Tag erstreckt. Auf Dächern mit Nordausrichtung und einer Neigung von mehr als 15 % ist die Solarstromerzeugung meist nicht wirtschaftlich, da der Ertrag insbesondere im Winter bei tiefstehender Sonne gering ist. Neben der zur Verfügung stehenden Dachfläche ist die Statik zu prüfen und mit dem Architekten oder Statiker abzuklären, ob das Dach für die zusätzliche Last (in der Regel 20-45 kg/m2 ) der PV-Anlage ausgelegt ist.';
            link = '../Planung.html#';
        }
